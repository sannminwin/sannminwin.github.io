...
(function(a, b, c, d) {
    ...
    a: c.allowDropdown, b:c.autoHideDialCode, c:c.autoPlaceholder, c2:c.customPlaceholder, d:c.dropdownContainer, e:c.excludeCountries, f:c.formatOnInit, g:c.geoIpLookup, h:c.initialCountry, i:c.nationalMode, j:c.numberType, k:c.onlyCountries, l:c.preferredCountries, m:c.separateDialCode, n:c.utilsScript;
}
)), this.b=a.extend( {
}
, h, c), this.ns="."+f+g++, this.d=Boolean(b.setSelectionRange), this.e=Boolean(a(b).attr("placeholder"));
}
var f="intlTelInput", g=1, h= {
    a: !0, b:!0, c:!0, c2:null, d:"", e:[], f:!0, g:null, h:"", i:!0, j:"MOBILE", k:[], l:["us", "gb"], m:!1, n:""}
, i= {
    b: 38, c:40, d:13, e:27, f:43, A:65, Z:90, j:32, k:9;
}
;
    a(b).load(function() {
...
, _c2: function(b, c) {
    ...
    for(d=0;
    d<b.length;
    d++)b[d]=b[d].toLowerCase();
    for(this.p=[], d=0;
    d<j.length;
    d++)c(a.inArray(j[d].iso2, b))&&this.p.push(j[d]);
}
, _d: function() {
...
;
    ...
    a++) {
    var b=this.p[a];
    if(this._c(b.iso2, b.dialCode, b.priority), b.areaCodes)for(var c=0;
    c<b.areaCodes.length;
    c++)this._c(b.iso2, b.dialCode+b.areaCodes[c]);
}
}
, _e: function() {
    this.r=[];
...
, _l:function() {
    var a=this;
    this.a.on("mousedown"+this.ns, function(b) {
    a.a.is(": focus")||a.a.val()||(b.preventDefault(), a.a.focus());
}
), this.a.on("focus"+this.ns, function() {
    a.a.val()||a.a.prop("readonly")||!a.s.dialCode||(a.a.val("+"+a.s.dialCode), a.a.one("keypress.plus"+a.ns, function(b) {
    b.which==i.f&&a.a.val("");
}
), setTimeout(function() {
    var b=a.a[0];
    if(a.d) {
    var c=a.a.val().length;
    ...
    var b=a.a.val(), c="+"==b.charAt(0);
    if(c) {
    var d=a._m(b);
    d&&a.s.dialCode!=d||a.a.val("");
}
a.a.off("keypress.plus"+a.ns);
}
);
}
, _m: function(a) {
...
, _u: function(c, d, e) {
    d&&b.intlTelInputUtils&&this.s&&(a.isNumeric(e)||(e=this.b.i||"+"!=c.charAt(0)?intlTelInputUtils.numberFormat.NATIONAL: intlTelInputUtils.numberFormat.INTERNATIONAL), c=intlTelInputUtils.formatNumber(c, this.s.iso2, e)), c=this._ah(c), this.a.val(c);
}
, _v:function(b, c) {
...
, _y: function(a, b, c) {
    for(var d=b?j: this.p, e=0;
    e<d.length;
    e++)if(d[e].iso2==a)return d[e];
    if(c)return null;
...
, this.s.iso2&&(this.j=this.s.iso2), this.l.attr("class", "iti-flag "+a);
...
, _ad: function(a, b) {
    var c=this.m, d=c.height(), e=c.offset().top, f=e+d, g=a.outerHeight(), h=a.offset().top, i=h+g, j=h-e+c.scrollTop(), k=d/2-g/2;
...
, destroy: function() {
    this.allowDropdown&&(this._ac(), this.l.parent().off(this.ns), this.a.closest("label").off(this.ns)), this.a.off(this.ns);
    var a=this.a.parent();
    a.before(this.a).remove();
}
